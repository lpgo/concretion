...
export default {
  data() {
    return {
      ...
      fukuan:[
        {label:"查询",icon:"search",items:[{title: "采购查询", url: "/purchaseSearch"},{title: "结账", url: "/checkout"}]},
      ],
      bengfang:[
        {label:"磅房",icon:"devices",items:[{title:"录入过磅单", url:"/purchase"},{title:"磅单流水",url:"/purchaseDiary"}]},
      ],
      diaodu:[
        {label:"销售",icon:"local_shipping",items:[{title: "录入出货单", url: "/outSale"},{title: "销售任务", url: "/customer"}]},
        {label:"查询",icon:"search",items:[{title: "销售查询", url: "/saleSearch"}]},
      ],
      shiyanshi:[
        {label:"销售",icon:"local_shipping",items:[{title: "录入出货单", url: "/outSale"},{title: "销售任务", url: "/customer"}]},
        {label:"查询",icon:"search",items:[{title: "销售查询", url: "/saleSearch"}]},
